...
#define vpt ((volatile Pte *)UVPT)			      // virtual page table
#define vpd ((volatile Pde *)(UVPT + (PDX(UVPT) << PGSHIFT))) // virtual page directory
...
int read_cmd_history(int index, char *cmd);
// ipc.c
